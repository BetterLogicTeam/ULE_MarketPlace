...
export default function AuctionModal() {
  ...
  const auction = async () => {
    ...
    if (Pages == "ULE") {
       res = await axios.get(
        `https://openmarket-nft.herokuapp.com/marketplace_categorywise_Auction_history?category=ULE`
      );
    } else if (Pages == "CST") {
       res = await axios.get(
        `https://openmarket-nft.herokuapp.com/marketplace_categorywise_Auction_history?category=CST`
      );
    } else if (Pages == "WHE") {
       res = await axios.get(
        `https://openmarket-nft.herokuapp.com/marketplace_categorywise_Auction_history?category=WHE`
      );
    } else {
       res = await axios.get(
