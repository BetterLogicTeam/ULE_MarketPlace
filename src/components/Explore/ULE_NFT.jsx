...
export default function ULE_NFT() {
  ...
  const Fatch_Api_data = async () => {
    try {
      ...
      let res = await axios.get("https://openmarket-nft.herokuapp.com/marketplace_categorywise_sell_history?category=ULE")
                ...
                return (
                  <>
                    <div class="fl-item col-xl-4 col-lg-4 col-md-6 col-sm-6" style={{ display: "block", cursor: "pointer" }}>
                      <div class="sc-card-product" onClick={() => myHistory.push(`/purchase/${ule}/${index}`)}>
